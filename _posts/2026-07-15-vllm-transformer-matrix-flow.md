...
date: 2026-07-15
permalink: /blogs/vllm-transformer-matrix-flow
tags:
  - transformer
  - llm
  - attention
...
+---------------------------------------------------------------+
|Attention 层                                                   |
|  输入 all-reduce: 2048 x 8192 x 2B = 32 MB (读+写 = 64 MB)    |
|  输出 all-reduce: 同上 = 64 MB                                |
|  Attention 通信 = 128 MB                                      |
+---------------------------------------------------------------+
|FFN 层                                                         |
|  W_gate/W_up all-reduce: 2048 x 28672 x 2B = 112 MB           |
|  (读+写 = 224 MB)                                             |
|  FFN 通信 = 224 MB                                            |
+---------------------------------------------------------------+
|单层总计: 128 + 224 = 352 MB                                   |
|80 层: 352 x 80 = 28.16 GB                                     |
|                                                               |
